        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leaderboards_Sports_SportId",
                        column: x => x.SportId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<int>(type: "int", nullable: true),
                    PredictedHomeTeamScore = table.Column<int>(type: "int", nullable: false),
                    PredictedAwayTeamScore = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Predictions_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Injuries_TeamId",
                table: "Injuries",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_Leaderboards_SportId",
                table: "Leaderboards",
                column: "SportId");
